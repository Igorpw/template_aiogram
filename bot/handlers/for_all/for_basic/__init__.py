...
from bot.utils.for_all.for_basic.callback_data_factories import BasicCallback, BasicAction
# Создание маршрутизатора
router = Router()

# Регистрация обработчиков
router.message.register(start, CommandStart())
router.message.register(clicked_kb, Text(text='Кнопка для руководства'))
